...
func (self *noise) Eval2(x, y float64) float64 {
...
func (self *noise) Eval3(x, y, z float64) float64 {
...
func (self *noise) Eval4(x, y, z, w float64) float64 {
	// Place input coordinates on simplectic honeycomb.
	...
	if inSum <= 1 { // We're inside the pentachoron (4-Simplex) at (0,0,0,0)
		...
		if attn0 > 0 {
			attn0 *= attn0
			value += attn0 * attn0 * self.extrapolate4(xsb+0, ysb+0, zsb+0, wsb+0, dx0, dy0, dz0, dw0)
		}
		...
		if attn1 > 0 {
			attn1 *= attn1
			value += attn1 * attn1 * self.extrapolate4(xsb+1, ysb+0, zsb+0, wsb+0, dx1, dy1, dz1, dw1)
		}
		...
		if attn2 > 0 {
			attn2 *= attn2
			value += attn2 * attn2 * self.extrapolate4(xsb+0, ysb+1, zsb+0, wsb+0, dx2, dy2, dz2, dw2)
		}
		...
		if attn3 > 0 {
			attn3 *= attn3
			value += attn3 * attn3 * self.extrapolate4(xsb+0, ysb+0, zsb+1, wsb+0, dx3, dy3, dz3, dw3)
		}
		...
		if attn4 > 0 {
			attn4 *= attn4
			value += attn4 * attn4 * self.extrapolate4(xsb+0, ysb+0, zsb+0, wsb+1, dx4, dy4, dz4, dw4)
		}
		...
		if attn4 > 0 {
			attn4 *= attn4
			value += attn4 * attn4 * self.extrapolate4(xsb+1, ysb+1, zsb+1, wsb+0, dx4, dy4, dz4, dw4)
		}
		...
		if attn3 > 0 {
			attn3 *= attn3
			value += attn3 * attn3 * self.extrapolate4(xsb+1, ysb+1, zsb+0, wsb+1, dx3, dy3, dz3, dw3)
		}
		...
		if attn2 > 0 {
			attn2 *= attn2
			value += attn2 * attn2 * self.extrapolate4(xsb+1, ysb+0, zsb+1, wsb+1, dx2, dy2, dz2, dw2)
		}
		...
		if attn1 > 0 {
			attn1 *= attn1
			value += attn1 * attn1 * self.extrapolate4(xsb+0, ysb+1, zsb+1, wsb+1, dx1, dy1, dz1, dw1)
		}
		...
		if attn0 > 0 {
			attn0 *= attn0
			value += attn0 * attn0 * self.extrapolate4(xsb+1, ysb+1, zsb+1, wsb+1, dx0, dy0, dz0, dw0)
		}
		...
		if attn5 > 0 {
			attn5 *= attn5
			value += attn5 * attn5 * self.extrapolate4(xsb+1, ysb+1, zsb+0, wsb+0, dx5, dy5, dz5, dw5)
		}
		...
		if attn6 > 0 {
			attn6 *= attn6
			value += attn6 * attn6 * self.extrapolate4(xsb+1, ysb+0, zsb+1, wsb+0, dx6, dy6, dz6, dw6)
		}
		...
		if attn7 > 0 {
			attn7 *= attn7
			value += attn7 * attn7 * self.extrapolate4(xsb+1, ysb+0, zsb+0, wsb+1, dx7, dy7, dz7, dw7)
		}
		...
		if attn8 > 0 {
			attn8 *= attn8
			value += attn8 * attn8 * self.extrapolate4(xsb+0, ysb+1, zsb+1, wsb+0, dx8, dy8, dz8, dw8)
		}
		...
		if attn9 > 0 {
			attn9 *= attn9
			value += attn9 * attn9 * self.extrapolate4(xsb+0, ysb+1, zsb+0, wsb+1, dx9, dy9, dz9, dw9)
		}
		...
		if attn10 > 0 {
			attn10 *= attn10
			value += attn10 * attn10 * self.extrapolate4(xsb+0, ysb+0, zsb+1, wsb+1, dx10, dy10, dz10, dw10)
		}
	...
	if attn_ext0 > 0 {
		attn_ext0 *= attn_ext0
		value += attn_ext0 * attn_ext0 * self.extrapolate4(xsv_ext0, ysv_ext0, zsv_ext0, wsv_ext0, dx_ext0, dy_ext0, dz_ext0, dw_ext0)
	}
	...
	if attn_ext1 > 0 {
		attn_ext1 *= attn_ext1
		value += attn_ext1 * attn_ext1 * self.extrapolate4(xsv_ext1, ysv_ext1, zsv_ext1, wsv_ext1, dx_ext1, dy_ext1, dz_ext1, dw_ext1)
	}
	...
	if attn_ext2 > 0 {
		attn_ext2 *= attn_ext2
		value += attn_ext2 * attn_ext2 * self.extrapolate4(xsv_ext2, ysv_ext2, zsv_ext2, wsv_ext2, dx_ext2, dy_ext2, dz_ext2, dw_ext2)
	}
